...
import CustomStylePaginationRenderer from '@components/CustomStylePaginationRenderer.astro';
import NavJustifiedPaginationRenderer from '@components/NavJustifiedPaginationRenderer.astro';
...
<PaginationContainer>
  <CustomStylePaginationRenderer />
</PaginationContainer>

Don't want to create custom css? See the [included themes](/themes) or
alternatively see the [Tailwind Guide](/tailwind-pagination) or the [Bootstrap
Guide](/bootstrap-pagination)
...
| `inactiveItemClassName` | Appended to **\<li>** class name for the inactive element (defaults to `""`)                              |
...
<PaginationAndCode>
  <NavJustifiedPaginationRenderer
