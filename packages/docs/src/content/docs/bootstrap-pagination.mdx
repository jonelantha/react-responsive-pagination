...
<BootstrapThemeContainer hasBorder>
  <PaginationRenderer previousLabel="‹" nextLabel="›" client:load />
</BootstrapThemeContainer>
...
<BootstrapThemeContainer hasBorder>
  <PaginationRenderer renderNav={false} client:load />
</BootstrapThemeContainer>
...
<BootstrapThemeContainer>
  <PaginationRenderer extraClassName="justify-content-start" client:load />
</BootstrapThemeContainer>
