...
Not using Bootstrap framework? No problem, see the [included themes](/themes) featuring a standalone Bootstrap theme

Alternatively, see the [Tailwind Guide](/tailwind-pagination) or the [Custom Styles Guide](/custom-styled-pagination) guide
