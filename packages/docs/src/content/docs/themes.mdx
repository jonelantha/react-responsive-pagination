...
import ClassicThemePaginationRenderer from '@components/ClassicThemePaginationRenderer.astro';
import MinimalThemePaginationRenderer from '@components/MinimalThemePaginationRenderer.astro';
...
Alternatively see the [Custom CSS Guide](/custom-styled-pagination), [Tailwind Guide](/tailwind-pagination) or the [Bootstrap Guide](/bootstrap-pagination)
...
<PaginationContainer>
  <ClassicThemePaginationRenderer />
</PaginationContainer>
...
<PaginationContainer>
  <MinimalThemePaginationRenderer />
</PaginationContainer>
