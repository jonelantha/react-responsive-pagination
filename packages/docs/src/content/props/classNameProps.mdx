...
<Fragment>
  <PropDef name='containerClassName' type='string' defaultValue='pagination'>
  ...
  <PropDef name='inactiveItemClassName' type='string' defaultValue='undefined'>
  ...
  <PropDef name='classMerge' type='(classNames: string[]) => string' defaultValue='undefined'>
